        ...
        <div class="suggest_donors container-fluid">
            <div class="row">
                ...
                <div class="suggest1 col-lg-offset-3 col-md-offset-3 col-sm-offset-2 col-md-7 col-lg-7 col-xs-12 col-sm-7">
                    <h2>Suggest Here</h2>
                    <form class="form-horizontal col-md-12 col-lg-10 col-xs-11 col-sm-12" id="suggestform" method="POST">
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <textarea rows="5" cols="30" class="form-control suggestarea" name="suggestarea"   placeholder="Suggestion :*"> </textarea></div>
                        <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-6">
                            <button class="btn btn2 col-lg-offset-12 btn-md" type="submit">Suggest</button>
                        </div>
                    </form>
                </div>
